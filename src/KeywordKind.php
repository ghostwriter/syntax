...
final class KeywordKind
{
    ...
    public const T_POW_EQUAL = 273;

    public const T_PRINT = 266;

    public const T_PRIVATE = 312;

    public const T_PROTECTED = 311;

    public const T_PUBLIC = 310;
